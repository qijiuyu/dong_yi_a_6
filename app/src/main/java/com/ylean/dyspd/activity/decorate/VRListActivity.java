...
public class VRListActivity extends BaseActivity implements MyRefreshLayoutListener {
     ...
     * 筛选：风格，面积
     */
    private String dstyle, housearea;
    //页数
    private int page = 1;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_search:
                setClass(SearchVRActivity.class);
                break;
            //最新
            case R.id.rel_new:
                if (newSort == 1) {
            ...
            case R.id.tv_screening:
                setClass(ScreeningVRActivity.class, 100);
                break;
            default:
                break;
        }
