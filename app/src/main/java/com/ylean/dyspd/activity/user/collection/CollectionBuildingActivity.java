...
public class CollectionBuildingActivity extends BaseActivity implements MyRefreshLayoutListener {
    ...
    private CollectionBuildingAdapter collectionBuildingAdapter;
    //页数
    private int page = 1;
    //收藏id
    private int id;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initView();
        //获取热门楼盘列表
        getCollBuilding(HandlerConstant.GET_BUILDING_LIST_SUCCESS1);
    }
    ...
    private void initView() {
        tvTitle.setText("收藏的热门楼盘");
        linSelect.setVisibility(View.GONE);
        reList.setMyRefreshLayoutListener(this);
        collectionBuildingAdapter = new CollectionBuildingAdapter(this, listAll);
        listView.setAdapter(collectionBuildingAdapter);
    }
            ...
            switch (msg.what) {
                ...
                case HandlerConstant.CANCLE_COLL_SUCCESS:
                    ...
                    if(baseBean.isSussess()){
                        ...
                        collectionBuildingAdapter.notifyDataSetChanged();
    ...
    public void onLoadMore(View view) {
        page++;
        getCollBuilding(HandlerConstant.GET_BUILDING_LIST_SUCCESS2);
    }
     ...
     * 获取设计师列表
     */
    private void getCollBuilding(int index) {
        HttpMethod.getCollBuilding(String.valueOf(page), index, handler);
    }
