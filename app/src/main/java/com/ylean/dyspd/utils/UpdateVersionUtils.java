            ...
            switch (msg.what) {
                ...
                case HandlerConstant.UPDATE_VERSION_SUCCESS:
                    ...
                    if(version.isSussess() && version.getData()!=null){
                        //存储后台版本信息
                        SPUtil.getInstance(mContext).addInt(SPUtil.VERSION_CODE,version.getData().getCommonid());
                        //判断是否需要更新
                        if (version.getData().getCommonid()> Util.getVersionCode(mContext)) {
                            ...
                            tvConfirm.setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                    ...
                                    d.setDownPath(version.getData().getCommonvalue());
